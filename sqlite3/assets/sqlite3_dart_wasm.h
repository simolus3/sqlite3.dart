...
int dart_sqlite3_create_scalar_function(sqlite3* db, const char* zFunctionName,
                                        int nArg, int eTextRep, int id);

int dart_sqlite3_create_aggregate_function(sqlite3* db,
                                           const char* zFunctionName, int nArg,
                                           int eTextRep, int id);

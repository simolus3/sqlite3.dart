...
import_dart("path_normalize") extern int dartNormalizePath(const char *zPath, char *zOut, int nOut);
...
import_dart("fs_size") extern int dartFileSize(const char *zPath, sqlite3_int64* pSize);
import_dart("fs_truncate") extern int dartTruncate(const char *zPath, sqlite3_int64 pSize);
import_dart("fs_read") extern int dartRead(const char *zPath, void *into, int amt, sqlite3_int64 offset);
import_dart("fs_write") extern int dartWrite(const char *zPath, const void *from, int amt, sqlite3_int64 offset);
import_dart("fs_delete") extern int dartDeleteFile(const char *zPath);
import_dart("fs_access") extern int dartAccessFile(const char *zName, int flags, int *pResOut);

...
int sqlite3_open_v2(sqlite3_char* filename, sqlite3** ppDb, int flags, sqlite3_char* zVfs);
...
int sqlite3_bind_blob64(sqlite3_stmt *pStmt, int index, void* data, uint64_t length, void* destructor);
...
int sqlite3_bind_text(sqlite3_stmt* pStmt, int index, sqlite3_char* data, int length, void* destructor);
...
void sqlite3_result_blob64(sqlite3_context *ctx, void* data, uint64_t length, void *destructor);
...
void sqlite3_result_text(sqlite3_context* ctx, sqlite3_char* data, int length, void* destructor);

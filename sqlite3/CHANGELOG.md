...
- Linux: Pre-compiled libraries now support glibc 2.24.x as a minimum version (was 2.38.x before).
- Fix `IndexedDbFileSystem.flush()` not awaiting an ongoing write transaction.

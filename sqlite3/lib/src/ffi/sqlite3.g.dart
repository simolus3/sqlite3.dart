...
class Bindings {
  ...
  late final _sqlite3_errstrPtr = _lookup<
          ffi.NativeFunction<ffi.Pointer<sqlite3_char> Function(pkg_ffi.Int)>>(
      'sqlite3_errstr');
  ...
  late final _sqlite3_result_errorPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Pointer<sqlite3_context>,
              ffi.Pointer<sqlite3_char>, pkg_ffi.Int)>>('sqlite3_result_error');
  ...
  int sqlite3_create_collation_v2(
    ...
    ffi.Pointer<pkg_ffi.Int> xCompare,
    ffi.Pointer<ffi.Void> xDestroy,
  ) {

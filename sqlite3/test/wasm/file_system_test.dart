...
Future<void> main() async {
  group('in memory', () {
    _testSimple(() => FileSystem.inMemory());
  });

  group('indexed db', () {
    Future<IndexedDbFileSystem> open() {
      return IndexedDbFileSystem.open(dbName: _randomName());
    }

    _testSimple(open);
    _testWithSqlite(open);
  });
}
...
void _testSimple(FutureOr<FileSystem> Function() open) {
  late FileSystem fs;
...
void _testWithSqlite(FutureOr<FileSystem> Function() open) {
